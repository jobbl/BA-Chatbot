    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        for model in emotions:
            ...
            if emotions[model] == "threatened":
                response[model] = "Sounds like you had some stressful time. Life can seem a scary place. I understand. Maybe some time in nature could show you the gentle sides of life again."

        dispatcher.utter_message(text=response["ml"])
        dispatcher.utter_message(json_message=response["rule"])
...
class ReactionFuture(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        for model in emotions:
            ...
            if emotions[model] == "threatened":
                response[model] = "Even if the future looks stressful, it only is stressful as long as you nurture the reason for the stress. Maybe take a little break from worrying from time to time, spend time in nature or listening to music. It might open new perspectives."
